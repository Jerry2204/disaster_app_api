                    ...
                    <div class="col-md-6">
                        <form action="{{ route('report.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3 ">
                                ...
                                <label for="floatingSelect">Jenis Bencana</label>
                            </div>
                            ...
                            <div class="form-floating mb-3">
                                <textarea class="form-control" name="keterangan" style="height: 150px" id="keterangan" placeholder="Masukkan keterangan"></textarea>
